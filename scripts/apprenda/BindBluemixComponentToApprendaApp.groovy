...
/*
 * Properties being used for this integration
 * props.api
 * props.user
 * props.password
 * props.selfsigned
...
{
	// this crawls for known configuration files to inject the bluemix configuration into.
	
	// for all java apps - web.xml
	// .NET - app.config, web.config
	// Docker - we'll mod the dockerfile, this is the PaaS way to do it.
	// Linux Services - we'll leave as a development exercise :)
